        ...
        <div className="admin-modal-overlay">
          <div className="admin-modal" style={{ width: 'min(100%, 24rem)' }}>
            ...
            <div className="admin-modal-form" style={{ marginTop: '0.5rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '1rem', borderTop: '1px solid var(--border-color)', paddingTop: '1rem' }}>
                <button
                  type="button"
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" style={{ marginRight: '2px' }}>
